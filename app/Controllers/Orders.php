...
class Orders extends ResourceController
{
    ...
    public function getPurchaseHistory(){
        ...
        $payments = $paymentModel->getPaymentsByUserId($this->request->user_id);

        $manualPaymentsModel = model('App\Models\ManualPaymentsModel');
        $manual_payments = $manualPaymentsModel->getManualPaymentsByUserId($this->request->user_id);

        $response["payments"] = $payments;
        $response["manual_payments"] = $manual_payments;
        $response["user_id"] = $this->request->user_id;
